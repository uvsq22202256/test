...
public class RetraitRequestDTO {
    ...
    private String methodePayement; // VIREMENT_BANCAIRE, IBAN, etc.
    ...
    public RetraitRequestDTO(BigDecimal montant, String methodePayement, String reference) {
