...
/**
 * Événement Kafka - Dépôt effectué
 */
public class PortefeuilleDepotEffectueEvent implements Serializable {
    ...
    public PortefeuilleDepotEffectueEvent() {}

    public PortefeuilleDepotEffectueEvent(Long portefeuilleId, Long joueurId, String pseudo,
